        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {isLoading ? (
            Array(3).fill(0).map((_, i) => (
              <Card key={i} className="bg-black/40 backdrop-blur-sm rounded-2xl border-0">
            ...
            return (
              <Card 
                key={club.id} 
                className="bg-black/40 backdrop-blur-sm rounded-2xl overflow-hidden hover:bg-black/60 transition-colors cursor-pointer border-0"
