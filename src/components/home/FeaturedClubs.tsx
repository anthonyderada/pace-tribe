                  ...
                  <div className="p-6">
                    <div className="flex justify-between items-start gap-4">
                      <div>
                        ...
                        <p className="text-white/70 text-sm mt-1">{club.location || 'Location not specified'}</p>
                        <div className="flex flex-wrap gap-2 mt-2">
                          {club.club_label_assignments?.map((assignment) => (
                            <Badge
                              key={assignment.id}
                              variant="secondary"
                              className="bg-white/10 text-white/90 pointer-events-none"
                            >
                    ...
                    <p className="text-white/70 line-clamp-3 mt-4">{club.description || 'No description available'}</p>
                    <p className="text-white/70 text-sm mt-4">{club.club_members?.length || 0} members</p>
                  </div>
                </CardContent>
              </Card>
            );
